...
def pipeline_por_etapa(df_deals: pd.DataFrame) -> pd.DataFrame:
    """Deals que están AHORA en cada etapa del pipeline (vista de tablero HubSpot).

    A diferencia de `embudo` (acumulado y sin perdidos), esto reparte cada deal en
    su etapa ACTUAL e incluye 'Cierre ganado' y 'Cierre perdido'. Devuelve
